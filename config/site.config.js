...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'kevinnitro@kevinnitro.onmicrosoft.com',

  // [OPTIONAL] This is the website icon to the left of the title inside the navigation bar. It should be placed under the
  // /public directory of your GitHub project (not your OneDrive folder!), and referenced here by its relative path to /public.
  icon: 'https://cdn.jsdelivr.net/gh/KevinNitroG/KevinNitroG@main/icons/kevindex/kevindex-logo-128x128.png',
  ...
  email: 'mailto:kevinnitro@duck.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/KevinNitro',
    },
  ],
